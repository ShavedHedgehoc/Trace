...
class Test_login(BaseTest):
    ...
    def test_login_get(self):
        ...
        self.assertEqual(
            result, {"message": "The method is not allowed for the requested URL."}
        )
    ...
    def test_login_wrong_data(self):
        json_data = {"password": "1", "email": "test_user@unicosm.ru"}
    ...
    def test_login_pass_not_equal(self):
        user = User(
            UserName="test_user", UserEmail="test_user@gmail.com", UserPassword="1"
        )
        with self.app.app_context():
            self.user_repository.add_user(user)

        json_data = {"password": "2", "email": "test_user@gmail.com"}
