...
class LotItemRepository:
    ...
    def __header(self, id: int):
        data = (
            ...
            .join(Product, Lot.ProductId == Product.ProductId, isouter=True)
    ...
    def __query(self, id: int):
        ...
        lot_qry = (
            ...
            .distinct(lot_sbqry.c.batch_name)
            .order_by(lot_sbqry.c.year, lot_sbqry.c.month, lot_sbqry.c.number)
        )
        return lot_qry

    def __rows(self, query, options: LotItemRequestOptions):
