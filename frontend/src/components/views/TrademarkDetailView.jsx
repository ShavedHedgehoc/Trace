...
import TrademarkDetailTable from '../tables/TrademarkDetailTable.jsx';


const TrademarkDetailView = (props) => {
    ...
    const apiUrl = `/api/v1/trademarks/${props.trademarkId}?page=${page}&per_page=${perPage}`;
