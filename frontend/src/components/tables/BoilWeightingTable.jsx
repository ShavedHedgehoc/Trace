...
const BoilWeightingTable = (props) => {

    const clickRedirectToLot = (lotid) => {
        navigate("/lots/" + lotid);
    };
    ...
    const columns = [
        ...
        { id: '4', label: 'Взвесил', align: 'center', width: '140px', },
        { id: '5', label: 'Количество', align: 'center', width: '30px', },
        { id: '6', label: 'Дата', align: 'center', width: '80px', },
        { id: '7', label: 'Время', align: 'center', width: '40px', },
    ];
                ...
                <TableBody>
                    {props.data.map((row, index) => (
                        <StyledTableRow key={index}>
                            ...
                            <StyledTableCell align='center'>{parseFloat(row.quantity)}</StyledTableCell>
...
export default BoilWeightingTable;